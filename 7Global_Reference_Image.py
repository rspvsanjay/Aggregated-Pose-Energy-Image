...
# Main execution
base_subject_dir = f'E:\\Gait_IIT_BHU_Data\\Normalized_Images\\'
best_images_dir = f'E:\\Gait_IIT_BHU_Data\\reference_images\\Best_Images_Right_to_Left\\'
refined_avg_path1 = os.path.join(best_images_dir, 'refined_average_image.png')
aligned_images_dir1 = f'E:\\Gait_IIT_BHU_Data\\reference_images\\Aligned_Images\\'
refined_avg_path2 = os.path.join(aligned_images_dir1, 'refined_average_image.png')
aligned_images_dir2 = f'E:\\Gait_IIT_BHU_Data\\reference_images\\Aligned_Images2\\'
