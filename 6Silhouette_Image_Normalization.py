...
base_dir = f'E:\\Gait_IIT_BHU_Data\\Sequences_with_Labeled_Direction\\'
output_dir = f'E:\\Gait_IIT_BHU_Data\\Normalized_Images\\'
print("Path: ", base_dir)
...
for subject in range(1, 134):
    ...
    for sequence in os.listdir(subject_path):
        ...
        for image_file in os.listdir(sequence_path):
            ...
            new_height = 240  # Changed from 512 to 448
