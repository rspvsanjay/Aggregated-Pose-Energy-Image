...
def align_and_save_images(ref_image_path, input_root_dir, output_root_dir):
    ...
    for subject in range(1, 334):
        ...
        for sequence in os.listdir(subject_path):
            ...
            output_sequence_path = os.path.join(output_root_dir, subject_str, sequence)
            ...
            for image_file in os.listdir(sequence_path):
                if image_file.endswith('.png'):
                    ...
                    # Check if "right_to_left" is in filename; if not, flip horizontally
                    if "right_to_left" not in image_file:
...
ref_image_path = f'E:\\Gait_IIT_BHU_Data\\reference_images\\Aligned_Images2\\refined_average_image_binary.png'
input_root_dir = f'E:\\Gait_IIT_BHU_Data\\Normalized_Images'
output_root_dir = f'E:\\Gait_IIT_BHU_Data\\Normalized_Aligned_Images'
# Align images
